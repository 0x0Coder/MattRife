    ...
    >
      ...
      />
        ...
        <div className='grid mt-10'>
            ...
            <p className='text-white  text-xl mt-5'>Our mission is clear – to raise $250,000 by the end of this year, and every cent of your contribution and generous support plays a vital role in transforming the lives of the children in our care, providing them with essential resources, education, and a nurturing environment. Here’s how your donation will make a difference:</p>
    ...
    >
      ...
      />
        ...
        <div className='grid mt-10'>
            ...
            <p className='text-white text-xl mt-5'>With your support and generousity, that plays a vital role in transforming the lives of the children in our care, providing them with essential resources, education, and a nurturing environment. Together, we’ll create a story of resilience, strength, and hope that will echo for generations to come.</p>
