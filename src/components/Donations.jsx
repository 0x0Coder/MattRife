  ...
  return (
    <div className='san-serif'>
      ...
      <AccordionHeader onClick={() => handleOpen(2)} className={`text-white transition-colors ${
        ...
        <div className='grid justify-center mt-10'>
          <h1 className='text-customGold text-4xl grid justify-center'>Join Hands to Rebuild Hope: Donate for the Less Priveledged</h1>
        ...
        <div className='grid  mt-10'>
            <h1 className='text-white text-2xl grid text-left'>Change Lives, Write a Story of Resilience</h1>
            <h1 className='text-white text-4xl grid text-left mt-10'>The Heartbreaking Reality  </h1>
            ...
            <div className='mt-10 grid justify-end'>
              <Button variant="outlined" className='  hover:bg-white hover:text-secondary text-white'>Donate Now</Button>
              </div>
    ...
    >
      ...
      />
        ...
        <div className='grid mt-10'>
            <h1 className='text-white text-4xl'>Our Promise of Hope</h1>
            <p className='text-white mt-5'>At the Matt Rife Foundation, we believe in the power of compassion, unity, and change. We’ve witnessed the strength of communities coming together to support one another during times of adversity. Today, we invite you to be a part of this story of hope and transformation. We invite you to be the hero in their story.</p>
            <h1 className='text-white text-4xl mt-5'>A $250,000 Goal to Rebuild Lives</h1>
            <p className='text-white  mt-5'>Our mission is clear – to raise $250,000 by the end of this year, and every cent of your contribution will go towards helping the victims of the Russo-Ukrainian War. Here’s how your donation will make a difference:</p>
            <p className='text-white  mt-5'><strong>1. Emergency Relief:</strong> Your donations will provide immediate assistance to those in need, including food, water, blankets, and essential supplies. This assistance will ensure that the victims have their basic needs met during this critical time.</p>
            <p className='text-white  mt-2'><strong>2. Medical Support:</strong> By donating, you can contribute to the provision of medical supplies, equipment, and personnel to overwhelmed hospitals and clinics. This will enable them to provide life-saving care to the injured and provide assistance to those in need of medical attention.</p>
            <p className='text-white  mt-2'><strong>3. Shelter and Rehabilitation:</strong>  Donations will help in providing safe and secure shelters for displaced individuals. It will also contribute to the rebuilding of homes and infrastructure, facilitating the rehabilitation process.</p>
            <p className='text-white  mt-2'><strong>4. Psychological Assistance: </strong> Your support will enable the provision of counseling services and mental health support to those affected by the conflict. This will aid in their recovery and help them rebuild their lives with resilience.</p>
            <div className='mt-10 grid justify-end'>
              <Button variant="outlined" className='  hover:bg-white hover:text-secondary text-white'>Donate Now</Button>
              </div>
        </div>
    ...
    >
      ...
      />
        ...
        <div className='grid mt-10'>
            <h1 className='text-4xl text-white'>Your Gift, Their New Beginning</h1>
            <p className='text-white mt-5'>Donating is simple. Just click the “Donate Now” button below and contribute what you can. Every dollar gets us closer to our goal and helps us bring hope and healing to those who need it most.</p>
            <h1 className='text-4xl text-white mt-10'>A Story of Resilience Awaits</h1>
            <p className='text-white mt-5'>With your support, we aim to transform the lives of Russo-Ukrainian War victims by providing them with the tools they need to rebuild and recover. Together, we’ll create a story of resilience, strength, and hope that will echo for generations to come.</p>
            <h1 className='text-4xl text-white mt-10'>In Times of Despair, Let’s Be Their Beacon of Light</h1>
            <p className='text-white mt-5'>For any questions or assistance with your donation, please reach out to us at donate@mattrifelive.com. Your compassion is the beacon of light that will help guide these brave souls out of the darkness.</p>

        </div>
        {/*Section 8 ends here*/}
        {/*Section 9 startss here*/}
        <div className='grid mt-10'>
            <h1 className='grid justify-center text-customGold text-4xl'>A Deeper Look into the Crisis           </h1>
            <p className='text-white mt-5'>In the heart of Eastern Europe, the Russo-Ukrainian War has waged on for years. What began as a political dispute has escalated into a full-blown humanitarian crisis, affecting millions. Families have been separated, lives have been lost, and the future remains uncertain.</p>
            <h1 className='text-4xl text-white mt-10'>The Plight of Displaced Families</h1>
            <p className='text-white mt-5'>Imagine the pain of having to flee your home in the dead of night, leaving behind everything you’ve ever known. This is the reality for countless families in war-torn regions. They’ve sought refuge in overcrowded temporary shelters, facing unimaginable living conditions.</p>
            <h1 className='text-4xl text-white mt-10'>Overwhelmed Medical Facilities</h1>
            <p className='text-white mt-5'>The war has taken a heavy toll on healthcare facilities. Hospitals and clinics are overwhelmed, struggling to cope with the influx of wounded individuals. Medical supplies are running critically low, and skilled medical professionals are in high demand.</p>
            <h1 className='text-4xl text-white mt-10'>A Lack of Basic Necessities</h1>
            <p className='text-white mt-5'>Access to food, clean water, and sanitation facilities is limited in conflict-affected areas. The lack of these basic necessities poses a significant threat to the health and well-being of the victims, especially the children.</p>
            <h1 className='text-4xl text-white mt-10'>Psychological Trauma</h1>
            <p className='text-white mt-5'>The prolonged conflict has taken a toll on the mental health of the affected population. Many have experienced trauma and require psychological support to recover and rebuild their lives. Your donation can help heal not just physical wounds but emotional ones too.</p>
            <h1 className='text-4xl text-white mt-10'>Children Caught in the Crossfire</h1>
            <p className='text-white mt-5'>The youngest victims of this crisis are the children. They’ve witnessed horrors that no child should ever see. Their education has been disrupted, their dreams put on hold. Your support can give them a chance at a brighter future.</p>
            <p className='text-white mt-10 text-4xl'>Thank you for your generosity. Together, we’ll be the change they desperately need.</p>
            <div className='mt-10 grid justify-end'>
              <Button variant="outlined" className='  hover:bg-white hover:text-secondary text-white'>Donate Now</Button>
              </div>
        </div>
         ...
         {/*Section 10*/}
         <div className='grid mt-10'>
            <h1 className='grid text-left text-4xl text-white'>Supporting Positive Change Through Your Generosity</h1>
            <p className='text-white mt-5'>At the heart of the Matt Rife Foundation lies a commitment to creating positive change in the world. Our foundation is driven by the desire to make a meaningful impact on the lives of individuals and communities. By contributing to our cause, you become an integral part of this mission to bring about lasting transformation.</p>
         </div>
        {/*Sectiopn 10 ends here*/}
           {/*Section 11*/}
           <div className='grid mt-10'>
            <h1 className='grid text-left text-4xl text-white'>Our Cause and Goals:</h1>
            <h1 className='grid text-left text-4xl text-white mt-5'>Empowering Communities, Nurturing Dreams</h1>
            <p className='text-white mt-5'>At the Matt Rife Foundation, our cause is centered around empowering underprivileged communities and nurturing dreams that might otherwise go unrealized. We focus on various initiatives, from education to healthcare, from providing clean water to supporting arts and culture. Our overarching goal is to uplift individuals and help them build better, brighter futures for themselves and their families.</p>
            <h1 className='grid text-left text-4xl text-white mt-10'>Creating Lasting Impact</h1>
            <p className='text-white mt-5'>Every dollar you donate contributes to projects that bring about real change. Whether it’s building schools, establishing medical facilities, supporting young talents, or addressing urgent community needs, your contribution directly fuels these endeavors. With your help, we’re not just changing lives; we’re shaping the future.</p>
        
         </div>
        {/*Sectiopn 11 ends here*/}
          {/*Section 12*/}
          <div className='grid mt-10'>
            <h1 className='grid text-left text-4xl text-white'>Secure Donation Form:</h1>
            <h1 className='grid text-left text-4xl text-white mt-5'>Make a Meaningful Difference</h1>
            <p className='text-white mt-5'>Your generosity matters, and we’ve made it simple and secure to contribute to our initiatives. Our donation form ensures that your financial information is protected, allowing you to give with confidence. Whether you’re passionate about education, healthcare, or any other aspect of our work, your donation will have a direct impact on the lives of those we serve.</p>
            <h1 className='grid text-left text-4xl text-white mt-10'>Options for Giving:</h1>
            <h1 className='grid text-left text-4xl text-white mt-5'>Flexibility That Matches Your Passion</h1>
            <p className='text-white mt-5'>We offer a range of giving options to suit your preferences. You can make a one-time donation that contributes to our ongoing projects, or you can choose to make a recurring donation, providing consistent support for our initiatives over time. Your commitment, no matter the size, plays a vital role in our ability to create positive change.</p>
            <h1 className='grid text-left text-4xl text-white mt-10'>Join the Circle of Change</h1>
            <p className='text-white mt-5'>Your partnership with the Matt Rife Foundation is an investment in the future. Together, we can turn dreams into reality, create opportunities where they are needed most, and leave a legacy of compassion and progress.</p>
         </div>
        {/*Sectiopn 12 ends here*/}
             {/*Section 13*/}
             <div className='grid mt-10'>
            <h1 className='grid text-left text-4xl text-white'>Ready to Make a Difference?</h1>
